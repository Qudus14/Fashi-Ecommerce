...
export default function Basket() {
  ...
  return (
    <div className="container mx-auto p-4 h-screen flex flex-col">
      <div className="flex-grow overflow-y-auto mb-[200px]">
        {groupedCart.map(item => {
          const itemPrice = getItemPrice(item);
          const totalItemPrice = itemPrice * item.quantity;
          return (
            <div key={item.product_id} className="mb-4 p-4 border border-gray-200 rounded flex items-center justify-between">
      ...
      <div className="w-full bg-white p-6 border-t fixed bottom-0 left-0">
