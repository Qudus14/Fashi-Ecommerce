  ...
  return (
    <div className="container mx-auto px-2">
      <div className="flex flex-col md:flex-row py-2">
        ...
        <div className="hidden lg:block border border-gray-200 rounded w-1/4 pr-1">
                        ...
                        <div className="container mx-auto px-4">
                          <div className="row">
                            ...
                            >
                              ...
                              <motion.div
                                className="bg-customYellow hover:bg-customYellow/90 hover:text-gray-100 text-white px-4 py-2 inline-block rounded text-base font-semibold cursor-pointer"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
