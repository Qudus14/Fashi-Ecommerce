...
const WomenBanner = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true)
      setError(null)
      const url = `https://real-time-product-search.p.rapidapi.com/search-v2?q=${activeCategory}&country=uk&language=en&page=1&limit=10&sort_by=BEST_MATCH&product_condition=ANY&min_rating=ANY`
      const options = {
        method: 'GET',
        headers: {
