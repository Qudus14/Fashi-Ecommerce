                    ...
                    {order.products?.map((product) => (
                      ...
                      >
                        <div className="flex items-center gap-3 sm:gap-4">
                          {product.product.product_photos && product.product.product_photos[0] && (
                            <div className="relative h-14 sm:h-14 sm:w-16 flex-shrink-0 rounded-md overflow-hidden">
                              <Image
                                src={product.product.product_photos[0]}
