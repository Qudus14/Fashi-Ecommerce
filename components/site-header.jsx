...
export function SiteHeader() {
  ...
  return (
    <div className="sticky top-0 z-40 bg-gray-800 w-full pt-2 md:pt-0 border-b border-gray-200 justify-between sm:px-6 px-5 lg:px-8">
      <div className="sm:pt-0 sm:pb-2 pb-1 flex flex-col items-center space-y-4 md:flex-row md:justify-between md:space-y-2">
        {/* Logo section */}
        ...
        <div className="w-full px-4 md:px-0 text-center">
          <form
            ...
            className="flex items-center border-white bg-white border rounded-full w-full flex-1"
          >
            <input
              type="text"
              value={searchTerm}
